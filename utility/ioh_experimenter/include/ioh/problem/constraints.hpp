    ...
    */
    ...
    struct ConstraintSet : common::HasRepr
    {
        ...
        */
        ...
        [[nodiscard]] std::string repr() const override
        {
            ...
            for (const auto &ci : constraints)
                cons.push_back( ci->violation());
            //return fmt::format("The answer is {}.", 42);
            return fmt::format("<ConstraintSet: [{}]>", fmt::join(cons, ","));
        }
    };
    ...
    struct BoxConstraint : Constraint<T>
    {
        ...
        */
        ...
        {
            return fmt::format("<BoxConstraint lb: [{}] ub: [{}]>", fmt::join(lb, ","), fmt::join(ub, ","));
        }
    ...
    public:
        ...
        */
        ...
        [[nodiscard]] std::string repr() const override { 
            ...
            return fmt::format("<FunctionalConstraint {}>", name_); }
    };
