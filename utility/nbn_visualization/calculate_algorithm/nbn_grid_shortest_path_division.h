#ifndef NBN_GRID_SHORTEST_PATH_SAMPLE_H
#define NBN_GRID_SHORTEST_PATH_SAMPLE_H
...
namespace ofec {
	class NBN_GridDivision_ShortestPath: public NBN_DivisionBase {
	public:
	...
	protected:
		...
		void mergePeaks(int curId, std::vector<int> & peaksId);
		void mergePeaks(const std::vector<int>& ranges, std::vector<int>& peaksId);
	...
	public:
		...
		NBN_GridDivision_ShortestPath() = default;
		~NBN_GridDivision_ShortestPath() {
