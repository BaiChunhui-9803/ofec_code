#ifndef NBN_NEAREST_BETTER_CALCULATOR_HNSW_H
#define NBN_NEAREST_BETTER_CALCULATOR_HNSW_H
...
namespace ofec {
	struct NBN_NearestBetterCalculatorHNSW {
	...
	public:
		...
		static void calculateHNSW(const std::vector<SolutionBase*>& m_sols,
