...
{				
	...
	md::TypedArray<double> xIn = factory.createArray<double>({1, 12}, {0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.0, 0.0, 0.0});
	md::TypedArray<double> nullIn = factory.createArray<double>({1, 2}, {50.0, 120.0});
	md::TypedArray<double> phi_desiredIn = factory.createArray<double>({1, 1}, {180.0});
	md::TypedArray<double> distanceIn = factory.createArray<double>({1, 1}, {0.5});
	try {
		...
		std::vector<md::Array> inputs{xIn, nullIn, phi_desiredIn, distanceIn};
		auto result = lib->feval(u"antennafunccircular", 3, inputs);
