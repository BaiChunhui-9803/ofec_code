...
{									
	...
	md::TypedArray<double> edge_aIn = factory.createArray<double>({1, 2}, {1.0, 2.0});
	md::TypedArray<double> edge_bIn = factory.createArray<double>({1, 2}, {2.0, 3.0});
	md::TypedArray<double> xIn = factory.createArray<double>({1, 3}, {1.0, 2.0, 3.0});
	md::TypedArray<double> yIn = factory.createArray<double>({1, 3}, {1.0, 2.0, 3.0});
	md::TypedArray<double> zIn = factory.createArray<double>({1, 3}, {1.0, 2.0, 3.0});
	md::TypedArray<double> node_fitIn = factory.createArray<double>({1, 3}, {1.0, 2.0, 3.0});
	...
	try {
		...
		auto lib = mc::initMATLABLibrary(app, u"drawNBNfun.ctf");
		std::vector<md::Array> inputs{figureIdIn, edge_aIn, edge_bIn, xIn, yIn, zIn, node_fitIn, numColorIn, basicNodeSizeIn};
		lib->feval(u"drawNBNfun", 0, inputs);
