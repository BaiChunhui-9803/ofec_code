function []= NBN_Data_MatlabOutput(filedir, filepath,  nbn_pos,nbn_pos_color_vals,nbn_pos_zvalues, virtual_nbn_pos_idxs, m_nbn_edges,m_nbn_edges_dis2parent,m_virtual_nbn_edges_idxs, m_opt_nbn_idxs, m_flag_continousFit2D, m_fit2d_pos,m_NBN_id_to_fit2D_id,m_fit2D_id_to_NBN_id,m_ranges,m_mesh2D_colors,m_mesh2D_zval,m_markers_nbn_idxs)
filename = filedir +"/NBN_matlab_data/"+ filepath+".xls";
Fdir = filedir +"/NBN_matlab_data";
mkdir(Fdir);
