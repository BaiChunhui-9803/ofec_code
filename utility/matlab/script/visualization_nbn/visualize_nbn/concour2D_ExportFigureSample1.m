...
fontSize = 20;
numTrainingPoints = 1000000; % Number of points we'll have to try to estimate our image everywhere.
imageWidth = 100;
...
cut = 100;
contour3Level=500;
filename= 'E:/Document/technical_report/visualize_of_fitness_landscaple/matlab_figure/show_save_img_setWindows/showMesh/imgNew28';
filetype= 'png';
fontsize = 15;
