function []= Graph3DColorMarkerAxis_ExportFigure(n,EdgeB,EdgeA, X,Y,Z,colorR,colorG,colorB, markerPtrs,Psize,filename, filetype, fontSize,colorbar_label, axis_label)
colorArr3(:,1) = colorR(:);
colorArr3(:,2) = colorG(:);
colorArr3(:,3) = colorB(:);
g = graph(EdgeB,EdgeA);
