...
cut = 100;
contour3Level=500;
filename= 'E:/Document/technical_report/visualize_of_fitness_landscaple/matlab_figure/show_save_img_setWindows/showMesh/imgNew202209131520';
filetype= 'png';
fontsize = 20;
colorbar_label = 0;
axis_label = 1;
Graph3DColorMarker_ExportFigure(n, EdgeB, EdgeA, xi, yi, zi, colorR, colorG, colorB, markerPtrs, Psize, filename, filetype, fontSize,colorbar_label, axis_label);