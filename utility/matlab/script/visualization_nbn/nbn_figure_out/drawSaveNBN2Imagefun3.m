function[] = drawSaveNBN2Imagefun3(figureId,filepath,filetype, edge_a,edge_b,x,y,z,node_fit,numColor,basicNodeSize,linewidth)
...
nbn_plot = plot(nbn_graph,'XData',x,'YData',y,'ZData',z,'NodeColor', gray_color , 'LineWidth',linewidth ,'EdgeColor',gray_color);
hold on;
nbn_points=  scatter3(x,y,z,node_size,node_color,'filled');


    outputfilename=strcat(filepath,"_fitness_nbn");   
