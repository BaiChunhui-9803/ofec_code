...
saveDir = "E:/DiaoYiya/experiment_figure/TSP_figure/LON4/";
mkdir(saveDir);
saveTextDir = "E:/DiaoYiya/experiment_figure/TSP_figure/LON4_txt/";
mkdir(saveTextDir);
...
if(tsp_filenames(dirId).isdir&&filename~="."&&filename~="..")
display(filename);
