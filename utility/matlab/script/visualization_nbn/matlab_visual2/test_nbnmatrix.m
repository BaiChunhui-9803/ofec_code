...
filename = "ProName_Classic_equal_maxima_expanded_Dim_2";
...
readfilepath = "Z:/student/2018/diaoyiya/nbn_experiment/conProNBN_total/"+filename+"_SampleSize_2000025_Opt_mesh3d.txt";
...
readfilepath = "Z:/student/2018/diaoyiya/nbn_experiment/conProNBN_total/"+filename+"_SampleSize_2000025_Opt_nbn.txt";
...
for idx=1:sz_nbn(1,1)
    ...
    df_idy(idx) = int16(df_nory(idx)*1000);
    if df_idy(idx)==0
        df_idy(idx)=1;
    end
    df_color(idx,:) = colormap2D(df_idx(idx),df_idy(idx), :);
end



f3 = figure(3);
scatter(df_x,df_y,[],df_color);
colormap(gca,"winter")
