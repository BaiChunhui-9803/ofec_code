...
namespace ofec {
	...
	void ESs::run_() {
		...
		while (tag != Terminate) {
			...
			//std::cout << "runID: " << global::ms_global.get()->m_runID << " iteraton: " << m_iteration << "  total_eval: " << total_evaluations << " coverage: " << m_coverage_result[m_iteration] << " best: " << curr_best_obj <<std::endl;
