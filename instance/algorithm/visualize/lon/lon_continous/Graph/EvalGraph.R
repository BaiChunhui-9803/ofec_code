...
file= "E:/Diao_Yiya/paper/fitness_landscape/lon_continous_data/proname_MMOP_CEC2015_F01_dim_5/data_filtered/proname_MMOP_CEC2015_F01_dim_5.txt"
best <- 0
outputFile = "E:/Diao_Yiya/paper/fitness_landscape/lon_continous_data/proname_MMOP_CEC2015_F01_dim_5/result.txt"
...
#cat("here is some text", file = "1")

cat("RUNOOB", file= outputFile)
cat( paste0("noptima: ", noptima, "\n"),file=outputFile)
