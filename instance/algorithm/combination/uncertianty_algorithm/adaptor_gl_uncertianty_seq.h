...
//*********************************************************************************/
//
//#ifndef OFEC_GL_ADAPTOR_UNCERTIANTY_SEQ_H
//#define OFEC_GL_ADAPTOR_UNCERTIANTY_SEQ_H
//
//#ifdef  OFEC_DEMO
...
//		
//		std::shared_ptr<EvaluationStrategyBase> m_eval_stra;
//		int m_id_pop = 0;
//
...
//			m_id_pop = popId;
//		}
//		void setEvalStra(const std::shared_ptr<EvaluationStrategyBase>& eval_stra) {
