...
namespace ofec
{
    ...
    class LogNormalEA : public GeneticAlgorithmOneMax
    {

    public:

        static void setParameter(ParamMap& param, int lambda, double init_mutation_rate = 0.2)
      {
            m_param["lambda"] = lambda;
            m_param["init_mutation_rate"] = init_mutation_rate;
      }
        ...
        virtual void updateParamTypes(paramTypeMap& param) {
...

            {
                ...
                curPara.m_key = "init_mutation_rate";
                curPara.setRange(1, 30, 1, 1);
        ...
        void initialize_() override {
            ...
            init_mutation_rate = v.get<double>("init_mutation_rate");
