...
namespace ofec {
	...
	protected:
		...
		std::vector<std::unique_ptr<SolutionType>> m_indis;
	...
	public:
		...
		void globalUpdatePheromone(const TInterpreter& interpreter, Problem *pro, std::vector<std::unique_ptr<SolutionType>>& pops) override {
			++m_iteration;
		...
		bool stepNext(const TInterpreter& interpreter, int pro_id, SolutionType& cur, Random *rnd) override {
	...
	template<typename TInterpreter>
	inline void RIACO<TInterpreter>::updatePheromonePolicy(const std::vector<std::unique_ptr<SolutionType>>& update_sols) {
	...
	template<typename TInterpreter>
	inline bool RIACO<TInterpreter>::updateSolutions(Problem *pro, SolutionType& cur_indiv, std::vector<std::unique_ptr<SolutionType>>& curPops) {
