...
namespace LKH {
	...
	static void SplitSSegment(LKHAlg::Segment * t1, LKHAlg::Segment * t2);
	static void FlipNodes(LKHAlg::Node * a, LKHAlg::Node * b, LKHAlg::Node * c, LKHAlg::Node * d, LKHAlg *Alg);
	static void FlipSegments(LKHAlg::Segment * a, LKHAlg::Segment * b,
		LKHAlg::Segment * c, LKHAlg::Segment * d);
	static void FlipSSegments(LKHAlg::SSegment * a, LKHAlg::SSegment * b,
		LKHAlg::SSegment * c, LKHAlg::SSegment * d);

#define SPLIT_CUTOFF 0.75

	void LKHAlg::Flip_SSL(Node * t1, Node * t2, Node * t3)
	{
	...
	void SplitSSegment(LKHAlg::Segment * t1, LKHAlg::Segment * t2)
	{
		LKHAlg::SSegment *P = t1->Parent, *Q;
		LKHAlg::Segment *t, *u;
		int i, Count;
