...
#include "LKH.h"
namespace LKH {
	extern thread_local LKH::LKHAlg::Node **t;       /* The sequence of nodes to be used in a move */
	extern thread_local LKH::LKHAlg::Node **T;       /* The currently best t's */
	extern thread_local LKH::LKHAlg::Node **tSaved;  /* For saving t when using the BacktrackKOptMove function */
