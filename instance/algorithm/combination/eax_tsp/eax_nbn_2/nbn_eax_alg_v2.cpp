...
void ofec::NBN_EAX_Alg_V2::initialize_()
{
	Algorithm::initialize_();
	m_pop.reset(new PopNBN_EAX_V2);
	m_pop->initialize(m_problem.get(), m_random.get());
}

#ifdef OFEC_DEMO
void ofec::NBN_EAX_Alg_V2::updateBuffer()
{
