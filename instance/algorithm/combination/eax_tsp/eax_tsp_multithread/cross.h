#ifndef EAX_TSP_MULTITHREAD_CROSS_H
#define EAX_TSP_MULTITHREAD_CROSS_H
...
namespace ofec {
    namespace eax_tsp_mt {
        ...
        public:
            TCross(int N);
            //   ~TCross();
            void doIt(TIndi& tKid, TIndi& tPa2, int numOfKids, int flagP, const std::vector<int>& flagC, std::vector<std::vector<int>>& fEdgeFreq, Random* rnd);/* Main procedure of EAX */
            void doItWithoutParent(TIndi& tKid, int numOfKids, int flagP, const std::vector<int>& flagC, std::vector<std::vector<int>>& fEdgeFreq, Random* rnd);/* Main procedure of EAX */
            
            
            void setParents(const TIndi& tPa1, const TIndi& tPa2, const std::vector<int>& flagC, int numOfKids, Random* rnd);/* Set information of the parent tours */
            void setABcycle(const TIndi& parent1, const TIndi& parent2, const std::vector<int>& flagC, int numOfKids, Random* rnd); /* Step 2 of EAX */
