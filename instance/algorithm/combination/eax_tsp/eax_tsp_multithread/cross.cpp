...
void TCross::doIt( TIndi& tKid, TIndi& tPa2, int numOfKids, int flagP, const std::vector<int>& flagC, std::vector<std::vector<int>>& fEdgeFreq, Random* rnd)
{
    int Num;
    int jnum, centerAB;
    double gain;
...
void TCross::doItWithoutParent(TIndi& tKid, int numOfKids, int flagP, const std::vector<int>& flagC, std::vector<std::vector<int>>& fEdgeFreq, Random* rnd) {
    int Num;
    int jnum, centerAB;
    double gain;
    double BestGain;
...
void TCross::setABcycle( const TIndi& tPa1, const TIndi& tPa2, const std::vector<int>& flagC, int numOfKids, Random* rnd)
{
