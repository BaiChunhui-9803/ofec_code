...
void ofec::NBN_EAX_Alg_V3::initialize_()
{
	Algorithm::initialize_();
	m_pop.reset(new PopNBN_EAX_V3);
	m_pop->initialize(m_problem.get(), m_random.get());
}

#ifdef OFEC_DEMO
void ofec::NBN_EAX_Alg_V3::updateBuffer()
{
