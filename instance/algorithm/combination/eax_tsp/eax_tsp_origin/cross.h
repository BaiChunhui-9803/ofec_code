#ifndef EAX_TSP_CROSS_H
#define EAX_TSP_CROSS_H
...
namespace ofec {
    namespace eax_tsp {
        ...
        public:
            TCross(int N, const std::shared_ptr<Random> &rnd);
            //   ~TCross();
            void doIt(TIndi& tKid, TIndi& tPa2, int numOfKids, int flagP, const std::vector<int>& flagC, std::vector<std::vector<int>>& fEdgeFreq);/* Main procedure of EAX */
            void doItWithoutParent(TIndi& tKid, int numOfKids, int flagP, const std::vector<int>& flagC, std::vector<std::vector<int>>& fEdgeFreq);/* Main procedure of EAX */
            
            
            void setParents(const TIndi& tPa1, const TIndi& tPa2, const std::vector<int>& flagC, int numOfKids);/* Set information of the parent tours */
            void setABcycle(const TIndi& parent1, const TIndi& parent2, const std::vector<int>& flagC, int numOfKids); /* Step 2 of EAX */
