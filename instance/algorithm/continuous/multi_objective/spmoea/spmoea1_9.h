...
// 环境选择时，采用局部区域选择而不是全局排序
// 子代生成时，有三部分机制：前沿子空间，当前父代邻域，父代之间交互

#ifndef OFEC_SPMOEA1_9_H
#define OFEC_SPMOEA1_9_H

#include "spmoea.h"

namespace ofec {

	class SPMOEA1_9 :public SPMOEA {
	public:
