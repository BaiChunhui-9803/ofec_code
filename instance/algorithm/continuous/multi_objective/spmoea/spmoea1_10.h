...
// 在spmoea1_10的基础上，去除子空间流形距离的计算，子连通区域采用邻域交互产生子代
// 子代生成时，基于个体进行更新和选择：个体变好，更新；非支配

#ifndef OFEC_SPMOEA1_10_H
#define OFEC_SPMOEA1_10_H

#include "spmoea.h"

namespace ofec {

	class SPMOEA1_10 :public SPMOEA {
	public:
