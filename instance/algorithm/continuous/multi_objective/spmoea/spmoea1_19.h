...
// 在spmoea1_16的基础上，分析子空间的连通性，基于连通性聚类采样，再采样机器学习
// 进行采样，或是交替进行

#ifndef OFEC_SPMOEA1_19_H
#define OFEC_SPMOEA1_19_H

#include "spmoea.h"

namespace ofec {

	class SPMOEA1_19 :public SPMOEA {
	public:
		...
		void generateOffspring(Problem *pro, Algorithm *alg, Random *rnd, size_t switch_period);
		void generateIndOffspring(Problem* pro, Algorithm* alg, Random* rnd, size_t switch_peroid, std::vector<int> type);
