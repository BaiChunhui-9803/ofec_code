...
// 在spmoea1_18的基础上，限制种群初始化范围

#ifndef OFEC_SPMOEA1_14_H
#define OFEC_SPMOEA1_14_H

#include "spmoea.h"

namespace ofec {

	class SPMOEA1_14 :public SPMOEA {
	public:
		...
		void assignPop(size_t space_inx,Problem* pro, Algorithm* alg, Random* rnd);
		...
		std::vector<std::vector<Real>> samplePush(Solution<>& sol, size_t sample_num, Problem* pro, Algorithm* alg, Random* rnd);
	...
	private:
		...
		std::vector<size_t> m_select_space;
	};

}

#endif  // !OFEC_SPMOEA1_14_H