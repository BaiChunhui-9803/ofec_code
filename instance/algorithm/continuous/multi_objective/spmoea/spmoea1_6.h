...
// 在之前的基础上，去除子空间流形距离的计算，子连通区域采用邻域交互产生子代

#ifndef OFEC_SPMOEA1_6_H
#define OFEC_SPMOEA1_6_H

#include "spmoea.h"

namespace ofec {

	class SPMOEA1_6 :public SPMOEA {
	public:
