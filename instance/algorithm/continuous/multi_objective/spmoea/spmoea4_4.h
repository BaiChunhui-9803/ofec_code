...
// 在spmoea4_3的基础上，设置一部分自由个体进行内部演化，为主种群找出新的前沿区域
// 并且当自由种群到前排或者演化一定代数后，分析目标空间点分布，找出稀疏点位置附近
// 重新部署自由种群的个体位置进行搜索

#ifndef OFEC_SPMOEA4_4_H
#define OFEC_SPMOEA4_4_H
