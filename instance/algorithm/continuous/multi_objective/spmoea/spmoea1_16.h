...
// 在spmoea1_10的基础上，间隔采用连通集采样和子空间采样，限制子空间前沿解的邻域交互

#ifndef OFEC_SPMOEA1_16_H
#define OFEC_SPMOEA1_16_H

#include "spmoea.h"

namespace ofec {

	class SPMOEA1_16 :public SPMOEA {
	public:
