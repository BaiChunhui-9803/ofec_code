...
// 采用多种群搜索的方式，在子空间初始化一个子种群，以及一个全局子种群

#ifndef OFEC_SPMOEA1_7_H
#define OFEC_SPMOEA1_7_H

#include "spmoea.h"

namespace ofec {

	class SPMOEA1_7 :public SPMOEA {
	public:
