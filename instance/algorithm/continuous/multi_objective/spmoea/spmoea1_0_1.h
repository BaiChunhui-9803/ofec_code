...
*************************************************************************/
// Created: 8 Feb 2022 by Qingshan Tan (email:qingshan.t@cug.edu.cn)
// subspace clustering and multi-population according to the neighborhood 
// relationship between different Pareto layers
// focus on exploitation

#ifndef OFEC_SPMOEA1_0_1_H
#define OFEC_SPMOEA1_0_1_H

#include "spmoea.h"

namespace ofec {

	class SPMOEA1_0_1 :public SPMOEA {
	public:
		...
		void PopResourceAssign(std::vector<Real>& pop_exploit_ratio, std::vector<size_t>& assign_pop_resource, Problem* pro);
		void generateOffspring(Problem* pro, Random* rnd, const std::vector<size_t>& pop_resource, const std::vector<Real>& pop_exploit_ratio);
