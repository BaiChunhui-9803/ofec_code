...
// 在spmoea1_16的基础上，设置每个子空间的粒度进行划分，

#ifndef OFEC_SPMOEA1_17_H
#define OFEC_SPMOEA1_17_H

#include "spmoea.h"

namespace ofec {

	class SPMOEA1_17 :public SPMOEA {
	public:
