...
// 在spmoea1_10的基础上，根据解在子空间的前沿与否，是否为前沿子空间等采样

#ifndef OFEC_SPMOEA1_11_H
#define OFEC_SPMOEA1_11_H

#include "spmoea.h"

namespace ofec {

	class SPMOEA1_11 :public SPMOEA {
	public:
