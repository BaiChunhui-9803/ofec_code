...
// 在spmoea1_10的基础上，根据解是否为前沿子空间基于子空间概率前推或扩展

#ifndef OFEC_SPMOEA1_15_H
#define OFEC_SPMOEA1_15_H

#include "spmoea.h"

namespace ofec {

	class SPMOEA1_15 :public SPMOEA {
	public:
