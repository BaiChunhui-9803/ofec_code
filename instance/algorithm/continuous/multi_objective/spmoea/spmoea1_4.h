...
// subspace evolution for nonlinear PS
// focus on exploitation
// 在之前的基础上采用DE算子，并且优化子空间流形距离的计算方式

#ifndef OFEC_SPMOEA1_4_H
#define OFEC_SPMOEA1_4_H

#include "spmoea.h"

namespace ofec {

	class SPMOEA1_4 :public SPMOEA {
	public:
		...
		void PopResourceAssign(std::vector<size_t>& assign_pop_resource, size_t eval_num, Problem *pro);
