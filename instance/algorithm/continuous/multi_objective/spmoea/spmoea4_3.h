...
// 在spmoea4_1的基础上，设置一部分自由个体进行内部演化，为主种群找出新的前沿区域
// 并且当自由种群到前排或者演化一定代数后，重新选择合适的位置初始化

#ifndef OFEC_SPMOEA4_3_H
#define OFEC_SPMOEA4_3_H
