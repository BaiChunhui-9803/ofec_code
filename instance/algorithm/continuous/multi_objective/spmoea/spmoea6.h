...
// subspace split, learning the distribution of population by vectors in space
// record information in each population

#ifndef OFEC_SPMOEA6_H
#define OFEC_SPMOEA6_H

#include "spmoea.h"

namespace ofec {

	class SPMOEA6 :public SPMOEA {
	public:
		void initialize_();
