...
/*
   MMF11: 2 objs, 2 vars, one global PS, other are local PS. PS is a sin curve but is continuous, dims diff, PF is two discontinuous lines
*/
...
namespace ofec {
	class MMF11 : public MetricsMMOP {
	public:
		size_t m_num_ps;
	protected:
