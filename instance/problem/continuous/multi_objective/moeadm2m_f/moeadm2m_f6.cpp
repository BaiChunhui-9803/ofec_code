#include "moeadm2m_f6.h"

namespace ofec {
	void MOEADM2M_F6::evaluateObjective(Real* x, std::vector<Real>& obj) {
		Real sum = 0.;
	...
	void MOEADM2M_F6::sampleParetoSols(size_t sample_num) {
