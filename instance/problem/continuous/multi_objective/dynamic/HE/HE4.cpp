...
namespace ofec {
	...
	int HE4::updateEvaluationTag(SolutionBase& s, Algorithm *alg) {
	...
	void HE4::evaluateObjective(Real* x, std::vector<Real>& obj) {//recommend the number of variables is 20
		Real t = get_time();
