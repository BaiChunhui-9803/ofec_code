...
{
	"name": "MMOP_CEC2013_F10",
	"identifier": "MMOP_CEC2013_F10",
...
namespace ofec {
	namespace cec2013 {
		class Composition2 : public Composition, public MetricsMMOP {
			OFEC_CONCRETE_INSTANCE(Composition2)
		protected:
	...
	using MMOP_CEC2013_F10 = cec2013::Composition2;
}
