...
{
	"name": "MMOP_CEC2013_F11",
	"identifier": "MMOP_CEC2013_F11",
...
namespace ofec {
	namespace cec2013 {
		class Composition3 : public Composition, public MetricsMMOP {
			OFEC_CONCRETE_INSTANCE(Composition3)
		protected:
	...
	using MMOP_CEC2013_F11 = cec2013::Composition3;
}
