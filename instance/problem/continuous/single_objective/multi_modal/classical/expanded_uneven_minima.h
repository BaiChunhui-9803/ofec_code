...
{
	"name": "Classic_uneven_minima_expanded",
	"identifier": "ExpandedUnevenMinima",
...
namespace ofec {
	class ExpandedUnevenMinima : public Continuous, public MetricsMMOP {
		OFEC_CONCRETE_INSTANCE(ExpandedUnevenMinima)
	protected:
