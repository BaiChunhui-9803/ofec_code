...
{
	"name": "Classic_Himmelblau_expanded",
	"identifier": "ExpandedHimmelblau",
...
namespace ofec {
	class ExpandedHimmelblau : public Continuous, public MetricsMMOP {
		OFEC_CONCRETE_INSTANCE(ExpandedHimmelblau)
	protected:
