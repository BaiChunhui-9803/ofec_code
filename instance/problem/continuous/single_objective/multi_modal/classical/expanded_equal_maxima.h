...
{
	"name": "Classic_equal_maxima_expanded",
	"identifier": "ExpandedEqualMaxima",
...
namespace ofec {
	class ExpandedEqualMaxima : public Continuous, public MetricsMMOP {
		OFEC_CONCRETE_INSTANCE(ExpandedEqualMaxima)
	protected:
