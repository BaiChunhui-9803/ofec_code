...
{
	"name": "Classic_five_uneven_peak_trap",
	"identifier": "FiveUnevenPeakTrap",
...
namespace ofec {	
	class FiveUnevenPeakTrap : public Continuous, public MetricsMMOP {
		OFEC_CONCRETE_INSTANCE(FiveUnevenPeakTrap)
	protected:
