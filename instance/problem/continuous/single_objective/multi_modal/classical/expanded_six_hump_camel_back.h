...
{
	"name": "Classic_six_hump_camel_back_expanded",
	"identifier": "ExpandedSixHumpCamelBack",
...
namespace ofec {
	class ExpandedSixHumpCamelBack : public Continuous, public MetricsMMOP {
		OFEC_CONCRETE_INSTANCE(ExpandedSixHumpCamelBack)
	protected:
