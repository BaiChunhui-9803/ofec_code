...
{
	"name": "GOP_CEC2005_F19",
	"identifier": "GOP_CEC2005_F19",
...
namespace ofec {
	namespace cec2005 {
		class RotatedHybridNarrowBasin : public Composition, public MetricsGOP {
			OFEC_CONCRETE_INSTANCE(RotatedHybridNarrowBasin)
		protected:
	...
	using GOP_CEC2005_F19 = cec2005::RotatedHybridNarrowBasin;
}
