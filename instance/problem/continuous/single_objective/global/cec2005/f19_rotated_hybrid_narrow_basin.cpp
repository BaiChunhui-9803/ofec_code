...
namespace ofec::cec2005 {
	void RotatedHybridNarrowBasin::addInputParameters() {
		m_index_number = "19";
	}
	...
	void RotatedHybridNarrowBasin::setFunction(Environment *env) {
		m_num_function = 10;
	...
	void RotatedHybridNarrowBasin::evaluateObjective(Real *x, std::vector<Real> &obj) const {
	...
	void RotatedHybridNarrowBasin::updateOptima(Environment *env) {
