...
{
	"name": "GOP_CEC2005_F24",
	"identifier": "GOP_CEC2005_F24",
...
namespace ofec {
	namespace cec2005 {
		class RotatedHybridComposition4 : public Composition, public MetricsGOP {
			OFEC_CONCRETE_INSTANCE(RotatedHybridComposition4)
		protected:
	...
	using GOP_CEC2005_F24 = cec2005::RotatedHybridComposition4;
}
