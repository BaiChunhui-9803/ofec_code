...
void runTask() {
	...
	saveDir = ofec::g_working_directory + "/paper_com_experiment_data/totalTsp/eax_lkh_total_sortedX_nbn_compareResults2/";
	...
	std::cout << "run EAX vs LKH run compareResult3" << std::endl;
	...
	for (auto& it : filenames) {
		if (it == "u574.tsp") {
			...
			runEAX_LKH(dir3, saveDir, it, globalInfo);
		}
	}
