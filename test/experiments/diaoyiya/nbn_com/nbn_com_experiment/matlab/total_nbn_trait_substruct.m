...
outputdir ='//172.24.24.151/e/DiaoYiya/paper_com_experiment_data/total_tsp/totalNBN_eax_figure_substruct2/';
...
bestPos(:,4)=bestPos(:,4)+0.01; 
hold on;
best_points=  scatter3(bestPos(:,2),bestPos(:,3),bestPos(:,4),'filled','DisplayName','Optima $\mathbf o$');
best_points.MarkerFaceColor= 'none';
best_points.MarkerEdgeColor= 'k';
best_points.Marker= 'square';
best_points.SizeData= 200;
