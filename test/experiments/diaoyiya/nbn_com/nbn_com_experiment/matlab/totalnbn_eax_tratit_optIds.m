...
optIdDir= '\\172.24.242.8\share\Student\2018\YiyaDiao\code_total\data\paper_com_experiment_data\totalTsp3\eax_lkh_lon_nbndata_rnd_analysis/';
...
optIdName= optIdDir + tspname + "_optSolIds.txt";
sizeA= [1 2]; 
...
hold on;
opt_points=  scatter3(optPos(:,2),optPos(:,3),optPos(:,4),'filled');
